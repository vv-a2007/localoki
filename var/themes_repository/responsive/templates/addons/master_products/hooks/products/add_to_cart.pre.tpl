...
{if $product.vendor_product_id}
    <input type="hidden"
           name="company_id"
           value="{$company_id|default:$smarty.request.company_id}"
    />
    <input type="hidden"
           name="product_data[{$product.product_id}][extra][company_id]"
           value="{$company_id|default:$smarty.request.company_id}"
    />
    <input type="hidden"
           name="product_data[{$product.product_id}][extra][vendor_product_id]"
