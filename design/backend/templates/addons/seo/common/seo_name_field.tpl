...
<div class="control-group {if $share_dont_hide}cm-no-hide-input{/if}">
    ...
    <div class="controls">
        ...
        <div class="input-prepend">
            ...
            <input type="text" name="{$object_name}[seo_name]" id="elm_seo_name" size="10" value="{$object_data.seo_name}" class="input-long cm-seo-check-changed" /><span class="cm-field-suffix">{$parent_uri.suffix}</span>
