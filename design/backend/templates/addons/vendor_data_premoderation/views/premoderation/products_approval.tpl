    ...
    <tr>
        ...
        <td data-th="{__("tools")}">
            ...
            {if $product.approved == "Y" || $product.approved == "P"}
                {include file="common/popupbox.tpl" id="disapprove_`$product.product_id`" text="{__("disapprove")} \"`$product.product`\"" content=$smarty.capture.disapprove link_text=" " act="edit" link_class="icon-thumbs-down"}
            {/if}
            
            {if $product.approved == "P" || $product.approved == "N"}
                {include file="common/popupbox.tpl" id="approve_`$product.product_id`" text="{__("approve")} \"`$product.product`\""  content=$smarty.capture.approve link_text=" " act="edit" link_class="icon-thumbs-up"}
            {/if}
