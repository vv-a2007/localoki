...
<div class="row-fluid orders-wrap">
    <div class="span8">
        <div class="buttons-container">
            ...
            {include file="pickers/products/picker.tpl" meta="hidden products_picker" company_id=$order_company_id display="options_price" extra_var="order_management.add" data_id="om" no_container=true icon="icon-reorder" but_text="{__("advanced_products_search")}" show_but_text=false}
        </div>
