...
<tr valign="top">
    ...
    <td>
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input type="text" id="inventory_{$i.combination_hash}_product_code" name="inventory[{$i.combination_hash}][product_code]" size="16" maxlength={"ProductFieldsLength::PRODUCT_CODE"|enum} value="{$i.product_code}" />
            </div>
        </div>
