            ...
            {if $backup_files}
                <table class="table table-middle">
                    ...
                    {foreach $backup_files as $name => $file}
                        <tr>
                            <td><input type="checkbox" name="backup_files[]" value="{$file.name}" class="checkbox cm-item"/>
                            </td>
                            <td><a href="{"datakeeper.getfile?file=`$file.name`"|fn_url}"><span>{$file.name}</span></a></td>
                            <td>{$file.create}</td>
