...
{else}
    ...
    {if $user_data.firstname}
        {assign var="_title" value="`$user_data.firstname` `$user_data.lastname`"}
    {elseif $user_data.b_firstname}
        {assign var="_title" value="`$user_data.b_firstname` `$user_data.b_lastname`"}
    {else}
        {assign var="_title" value="`$user_data.email`"}
    {/if}
{/if}
