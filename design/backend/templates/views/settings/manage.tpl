...
{include file="common/mainbox.tpl" title_start=__("settings") title_end=$settings_title buttons=$smarty.capture.buttons content=$smarty.capture.mainbox sidebar_position="left"}
