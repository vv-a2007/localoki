    ...
    <table class="table table-tree table-middle">
        {if $header && !$parent_id}
            ...
            <tr>
                ...
                <th width="5%" class="mobile-hide">{include file="common/check_items.tpl" check_statuses=''|fn_get_default_status_filters:true}</th>
