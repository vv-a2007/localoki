...
$config['http_host'] = 'localoki.my';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'localoki.my';
$config['https_path'] = '';
...
$config['admin_index']    = 'paneluprav.php';
